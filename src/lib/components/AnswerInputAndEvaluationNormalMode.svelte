...
<div in:scale={{ start: 0.5 }} class="rounded-md shadow-lg p-4 bg-white flex flex-col space-y-4 max-w-xl mx-auto mb-8">
  {#if !showResult}
  ...
  {#if showResult}
    <div class="p-8 rounded-md flex flex-col gap-8" in:scale={{ start: 0.5 }}>
